    ...
    public function facebook_retrieve($section, $conditions)
    {
        ...
        switch(strval($section))
        {
            case 'settings':
                ...
                $settings = array('timing', 'timing_value', 'prefix', 'postfix', 'picture_dir', 'website_link', 'website_title', 'website_description', 'action_title', 'action_link', 'ispage', 'expires', 'last_post');
